...
const MyJobsPage = ({ 
  ...
  const portalType = userRole === 'business' && userMode === 'provider' ? 'business' : 'contractor';
    ...
    <div className="w-full min-h-screen bg-gray-50">
      ...
      <div className="flex min-h-[calc(100vh-64px)]">
        ...
        <main className="flex-1 p-2 sm:p-3 md:p-4 bg-gray-50 overflow-x-hidden">
          <div className="md:flex md:items-center md:justify-between mb-6">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-sm text-gray-500">
                View and manage all your assigned and completed jobs
              </p>
            </div>
          ...
          <MyJobsList userRole={userRole} userMode={userMode} />
        </main>
      </div>
    </div>
  );
